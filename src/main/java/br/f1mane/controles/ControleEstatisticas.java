...
public class ControleEstatisticas {
    ...
    public void tabelaComparativa() {
        ...
        Piloto pilotoSel = (Piloto) pilotos.get(controleJogo.getRandom().intervalo(0, pilotos.size() - 1));
        Piloto pilotoComp;
    ...
    private String preencherTabela(Piloto piloto1, Piloto piloto2,
        ...
        tabela1 = tabela1.replaceAll("volta1",
                Lang.msg("082") + (piloto2.getNumeroVolta()));
        tabela1 = tabela1.replaceAll("volta2",
                Lang.msg("082") + (piloto2.getNumeroVolta() - 1));
        tabela1 = tabela1.replaceAll("volta3",
                Lang.msg("082") + (piloto2.getNumeroVolta() - 2));
        for (int i = 1; i < 4; i++) {
