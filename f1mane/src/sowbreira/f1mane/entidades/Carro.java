...
public class Carro implements Serializable {
	...
	public final static String TIPO_PNEU_MOLE = "Pneu mole";
	public final static String TIPO_PNEU_DURO = "Pneu duro";
	public final static String TIPO_PNEU_CHUVA = "Pneu chuva";
	...
	public static final String GIRO_MIN = "Minimo";
	public static final String GIRO_NOR = "Normal";
	public static final String GIRO_MAX = "Maximo";
	public static final int GIRO_MIN_VAL = 1;
	public static final int GIRO_NOR_VAL = 5;
	public static final int GIRO_MAX_VAL = 9;
	public static final String MAIS_ASA = "Mais Asa";
	public static final String ASA_NORMAL = "Asa Normal";
	public static final String MENOS_ASA = "Menos Asa";
	private String img;
	private Color cor1;
	private Color cor2;
	...
	private int calculaModificadorAsa(int novoModificador, No no,
		...
		if (no.verificaCruvaAlta() || no.verificaRetaOuLargada()) {
			...
			if (MENOS_ASA.equals(getAsa())) {
				// System.out.println("++MENOS_ASA Alta");
				novoModificador++;
			}
			if (MAIS_ASA.equals(getAsa())) {
				// System.out.println("--MAIS_ASA Alta");
				novoModificador--;
			}
		}
		if (no.verificaCruvaBaixa()) {
			...
			if (MENOS_ASA.equals(getAsa())) {
				// System.out.println("--MENOS_ASA Baixa");
				novoModificador--;
			}
			if (MAIS_ASA.equals(getAsa())) {
				// System.out.println("++MAIS_ASA Baixa");
				novoModificador++;
			}
		}
		return novoModificador;
			...
			if (no.verificaCruvaAlta() || no.verificaCruvaBaixa()) {
				...
				if (TIPO_PNEU_MOLE.equals(tipoPneu)) {
					if ((indicativo > 10)) {
						...
						&& no.verificaCruvaBaixa() && (indicativo > 15)
						&& (indicativo < 70)) {
					novoModificador += 1;
			...
			if (piloto.isJogadorHumano()) {
				...
				if (Math.random() < modificador) {
					if (TIPO_PNEU_MOLE.equals(tipoPneu)) {
						...
						pneus -= ((40 * controleJogo.getNiveljogo()) * novoModificador);
					}
