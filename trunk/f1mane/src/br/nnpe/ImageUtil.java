...
public class ImageUtil {
    ...
    public static BufferedImage geraTransparencia(
        BufferedImage src, Color color
    ) {
        ...
        srcBufferedImage.getGraphics()
                        .drawImage(img.getImage(), 0, 0, null);

        BufferedImage bufferedImageRetorno =
            new BufferedImage(
                img.getIconWidth(), img.getIconHeight(),
                BufferedImage.TYPE_INT_ARGB
            );
        ...
        for (int i = 0; i < img.getIconWidth(); i++) {
            for (int j = 0; j < img.getIconHeight(); j++) {
                ...
                Color c =
                    new Color(
                        argbArray[0], argbArray[1], argbArray[2], argbArray[3]
                    );
