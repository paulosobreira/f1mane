...
public class PainelCircuito extends JPanel {
	...
	private Point pointDesenhaHelmet = new Point(10, 115);
	private No posisRec;
	...
	private void desenhaMiniPista(Graphics2D g2d) {
		...
		Point o = new Point(limitesViewPort.x + 5, limitesViewPort.y
				+ limitesViewPort.height - 230);
		// g2d.fillOval(limitesViewPort.x + 5, limitesViewPort.y + 330, 10, 10);
		double doubleMulti = circuito.getMultiplciador() * 3.5;
	...
	private void desenhaProblemasCarroSelecionado(Piloto pilotoSelecionado,
		...
		g2d.drawImage(helmetPiloto, limitesViewPort.x + pointDesenhaHelmet.x
				+ (Math.random() > 0.5 ? 1 : -1), limitesViewPort.y
				+ pointDesenhaHelmet.y + (Math.random() > 0.5 ? -1 : 0), null);
		// }
	...
	private void desenhaVelocidade(Graphics2D g2d) {
		...
		g2d.fillRoundRect(limitesViewPort.x + pointDesenhaVelo.x,
				limitesViewPort.y + pointDesenhaVelo.y + 118, largura + 10, 15,
				15, 15);
		...
		g2d.drawString(velo, limitesViewPort.x + pointDesenhaVelo.x + 3,
				limitesViewPort.y + pointDesenhaVelo.y + 130);
	}
	...
	private void desenhaDRS(Graphics2D g2d) {
		...
		g2d.fillRoundRect(limitesViewPort.x + pointDesenhaVelo.x + 74,
				limitesViewPort.y + pointDesenhaVelo.y + 118, 34, 15, 15, 15);
		g2d.setColor(Color.BLACK);
