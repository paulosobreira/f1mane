# icones-hud-genericos — Delta Spec
...
### Requirement: Asset tyre.png
**Reason**: `png/tyre.png` não é referenciado por nenhum código Java, JavaScript ou HTML do projeto — asset morto.
**Migration**: Remover o arquivo de `src/main/resources/png/`; nenhuma mudança de código é necessária. Caso algum cliente externo requisitasse `/letsRace/png/tyre`, passará a receber erro de recurso inexistente — nenhum cliente conhecido o faz.
