...
**Nota de histórico**: esta change chegou a remover esse gate de voltas (avaliando toda volta, sem espera), a pedido do usuário durante teste em jogo real com `probalidadeChuva=99`. Depois de reconsiderar, o gate foi restaurado — este é o mecanismo da proposta original, mantido.
