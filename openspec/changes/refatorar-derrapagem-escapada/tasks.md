...
- [ ] 6.3 (pendente — acontece no `/opsx:archive`) Revisar `openspec/specs/escapada-ia-corrida/spec.md`, `openspec/specs/tracado-safe-lane-change/spec.md` e `openspec/specs/dead-code-removal/spec.md` após o merge das specs desta mudança, confirmando que refletem o comportamento final implementado.
