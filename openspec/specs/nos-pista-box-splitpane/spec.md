# nos-pista-box-splitpane

## Purpose

As listas de nós da pista e do box no editor de circuitos ficam dentro de um `JSplitPane` vertical redimensionável pelo usuário, em vez de um `GridLayout` de altura fixa.
