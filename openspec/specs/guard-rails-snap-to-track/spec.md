...
Fazer com que pontos de `ObjetoGuardRails` alinhem (snap) a nós de pista e a pontos de outros objetos de cenário próximos, tanto durante a criação ponto a ponto quanto ao arrastar um ponto existente em modo de edição, facilitando encostar guard rails com precisão na geometria da pista e em objetos vizinhos já posicionados.
