...
## Purpose
Isolamento do caminho de corrida do servidor headless em relação a Swing e `br.flmane.visao` — rendering opt-in, componentes gráficos criados sob demanda e contrato de corrida livre de tipos de UI.
