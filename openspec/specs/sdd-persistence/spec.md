...
## Purpose
Documents the persistence layer: Maven build profiles for H2 and MySQL, the JPA entity hierarchy rooted at `F1ManeDados`, and the relationships between concrete entities.
