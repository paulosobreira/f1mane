# Spec: tracado-decisao-prioridade-ia

## Purpose

Documenta a ordem de prioridade fixa das causas de mudança de traçado proativa avaliadas em `Piloto.processaMudarTracado()` a cada ciclo, e o requisito de que cada causa seja isolável e testável independentemente.
