# largada-bandeira-quadriculada

## Purpose

Desenhar uma linha de largada em padrão quadriculado (estilo bandeira) na posição do nó de largada do circuito, de forma consistente entre o editor de circuitos e a corrida ao vivo, independentemente de o circuito usar imagem de fundo estática ou gerada em memória.
