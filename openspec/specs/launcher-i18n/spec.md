...
## Purpose
Documents how the Swing launcher's action labels are translated via `Lang` and how the launcher JVM's i18n state stays isolated from the server's per-request translation.
