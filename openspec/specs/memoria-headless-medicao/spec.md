# memoria-headless-medicao

## Purpose
Procedimento reprodutível de medição de memória do servidor headless (RSS do cgroup + Flight Recorder), usado como critério de aceite de mudanças que alegam reduzir consumo.
