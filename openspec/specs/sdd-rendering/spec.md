...
## Purpose
Documents the rendering pipeline: how `PainelCircuito` paints each frame, its image buffers, and the `SpriteSheet` layout and extraction methods used to render cars and helmets.
