# web-ui-animacao-aparecimento-botao

## Purpose

Dar destaque visual (animação breve, ex.: salto ou piscada) a botões de ação nas telas de menu do cliente web quando eles transicionam de oculto para visível em resposta a uma seleção do jogador, sinalizando que uma nova ação ficou disponível. Restrito às telas de menu — nenhum componente do canvas de corrida é afetado.
