# web-selecao-preemptiva-temporada-circuito

## Purpose

Garantir que os carousels de seleção de temporada e circuito no cliente web nunca avancem sozinhos por temporização — a temporada/circuito selecionados só mudam em resposta a uma ação explícita do usuário, em todas as páginas que usam esses seletores.
