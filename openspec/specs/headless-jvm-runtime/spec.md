# headless-jvm-runtime

## Purpose
Flags de runtime da JVM do processo headless em container — AWT realmente headless e heap dimensionado pelo limite de memória do container, em vez do default de 1/4 da RAM do host.
