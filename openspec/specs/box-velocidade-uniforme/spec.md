# Spec: box-velocidade-uniforme

## Purpose

Garante que a velocidade/progresso de passagem pelo box e o limite de últimas voltas para decidir uma parada tardia sejam determinísticos e uniformes em qualquer corrida, eliminando o sorteio de um box "rápido" ou "lento" por partida.
