# Spec: Distribuição de Pontos de Carreira

## Purpose

Define as regras de custo e refund de pontos no sistema de upgrades de atributos do modo carreira, garantindo simetria entre upgrades e downgrades por faixa de nível.
