# Spec: piloto-modo-pilotagem-agressividade

## Purpose

Centraliza as regras de quando/como `modoPilotagem` (NORMAL/AGRESSIVO/LENTO) e o `giro` do motor afetam efetivamente o gameplay — em particular a regra de agressividade efetiva sob stress alto e o recuo proativo da decisão automática da IA.
