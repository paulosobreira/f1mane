...
## Purpose
Documents the multiplayer server architecture: the `PaddockServer` singleton, the `LetsRace` REST API, client session management, and the server-side game lifecycle.
