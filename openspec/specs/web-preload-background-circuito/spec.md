# web-preload-background-circuito

## Purpose

Antecipar o carregamento do JPG de fundo do circuito no cliente HTML5 para o momento em que o jogador confirma "Jogar", garantindo que a tela de corrida não bloqueie esperando uma segunda requisição e que a sala de espera (estado 07) exiba a pista, o contador de segundos para o início e a mensagem de carregamento em vez de uma tela em branco.
